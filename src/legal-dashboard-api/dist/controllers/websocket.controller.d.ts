...
export declare function emitSystemEvent(event: string, data: any): void;
export declare function emitDocumentEvent(documentId: string, event: string, data: any): void;
