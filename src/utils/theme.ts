...
export const getColorClasses = {
  ...
  status: {
    ...
    neutral: 'bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400',
  },
...
export type ColorVariant = keyof typeof getColorClasses.icon;
export type StatusVariant = keyof typeof getColorClasses.status;
