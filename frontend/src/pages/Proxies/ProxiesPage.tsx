...
import { Plus, Upload, RefreshCw, Download } from '../../utils/iconRegistry';
...
const ProxiesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-2">
        <h1 className="text-2xl font-bold text-neutral-900">مدیریت پروکسی‌ها</h1>
        <p className="text-neutral-600 mt-1">تنظیمات و مدیریت پروکسی‌های سیستم</p>
      </div>

      {/* Toolbar */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-[240px]">
          <input value={query} onChange={e => setQuery(e.target.value)} placeholder="جستجو (IP، کشور، برچسب)" className="w-full pr-3 pl-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
        </div>
