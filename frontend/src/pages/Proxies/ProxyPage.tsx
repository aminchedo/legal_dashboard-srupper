...
import { DownloadOutlined, FilterOutlined, GlobalOutlined, PlusOutlined, ReloadOutlined, SearchOutlined, SettingOutlined, UploadOutlined } from '../../icons/antd-stub';
...
import ProxyAnalyticsPanel from './ProxyAnalyticsPanel';
